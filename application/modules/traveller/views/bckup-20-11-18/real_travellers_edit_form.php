            ...
            <form class="m-form m-form--fit m-form--label-align-right" id="edittravelProfile" enctype="multipart/form-data">
                ...
                <?php endif;?>
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input class="form-control m-input datepicker" type="text" name="dob" id="dob" value="<?php if(is_array($editRec) && !empty($editRec[0]->birthday)): echo $editRec[0]->birthday; endif;?>" readonly data-date-format="yyyy-mm-dd"/> 
                        </div>
                    </div> 
                      <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-2 col-sm-12">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                             <select class="form-control m-select2" id="places_travelled" name="places_travelled[]" multiple="multiple">
                                <?php if(is_array($travelcities)):
                                    foreach($travelcities as $val){
                                ?>
