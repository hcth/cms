     ...
     <div class="m-portlet m-portlet--mobile">
           <!--  <div class="m-portlet__head">
            ...
            <?php if(is_array($editRec) && !empty($editRec)):
                       ?>
            <form id="edittravelProfile" enctype="multipart/form-data">
                <div>
                ...
                <?php endif;?>
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-9"> 
                                <?php if(is_array($editRec) && !empty($editRec[0]->name)): echo $editRec[0]->name; endif;?>  
                        </div>
                    </div>  
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                              <?php if(is_array($editRec) && !empty($editRec[0]->birthday)): echo $editRec[0]->birthday; endif;?> 
                        </div>
                    </div> 
                      <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-9">
                           <?php if(is_array($editRec) && !empty($editRec[0]->profession)): echo $editRec[0]->profession; else: echo "-"; endif;?>
                        </div>
                    </div> 
                      <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                           <?php if(is_array($editRec) && !empty($editRec[0]->bio)): echo $editRec[0]->bio; else: echo "-"; endif;?>
                        </div>
                    </div> 
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                     ...
                     <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-4">
                             <?php if(is_array($editRec) && !empty($editRec[0]->email)): echo $editRec[0]->email; endif;?>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-4">
                            <?php if(is_array($editRec) && !empty($editRec[0]->mobile)): echo $editRec[0]->mobile; else: echo "-"; endif;?>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">                        
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                           <a target="_blank" href="<?php if(is_array($editRec) && !empty($editRec[0]->linkdin)): echo $editRec[0]->linkdin; endif;?>"><?php if(is_array($editRec) && !empty($editRec[0]->linkdin)): echo $editRec[0]->linkdin; else: echo "-"; endif;?></a>
                        </div>
                    </div>  
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                           <a href="<?php if(is_array($editRec) && !empty($editRec[0]->facebook)): echo $editRec[0]->facebook; endif;?>" target="_blank"><?php if(is_array($editRec) && !empty($editRec[0]->facebook)): echo $editRec[0]->facebook; else: echo "-"; endif;?></a>
                        </div>
                    </div> 
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <a href="<?php if(is_array($editRec) && !empty($editRec[0]->twitter)): echo $editRec[0]->twitter; endif;?>" target="_blank"><?php if(is_array($editRec) && !empty($editRec[0]->twitter)): echo $editRec[0]->twitter; else: echo "-"; endif;?></a> 
                        </div>
                    </div> 
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
                        ...
                        <div class="col-lg-9">
                            <a href="<?php if(is_array($editRec) && !empty($editRec[0]->instagram)): echo $editRec[0]->instagram; endif;?>" target="_blank"><?php if(is_array($editRec) && !empty($editRec[0]->instagram)): echo $editRec[0]->instagram; else: echo "-"; endif;?></a> 
                        </div>
                    </div> 
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-lg-3">
            ...
            <!--end::Form-->
                ...
                <table id="table_stories" width="100%">
                    <thead>
                        <tr>
                            <th title="#">
                                #
