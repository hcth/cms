            ...
            <div class="alert alert-danger" style="text-align:left;display:none;" ></div>
                ...
                <div class="form-group m-form__group row">
                    ...
                    <div class="form-group m-form__group row">                        
                     ...
                     <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-9">
                            <div class="cropme" style="width: 540px; height: 616px;">
                            </div> 
                         <input type="hidden" name="" id="ttdThumb">
             ...
             <div class="alert alert-success" style="text-align:left;display:none;"></div> 
                    ...
                    <div class="form-group m-form__group row">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control m-input do_validation editor" id="editor" rows="5" name="article_description"></textarea>
                            <span class="m-form__help">
                     ...
                     <div class="col-lg-9">
                         <div class="cropme cropme2" style="width: 600px; height: 650px;">
                            </div> 
