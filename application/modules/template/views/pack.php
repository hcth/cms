              ...
              <li class="icon-box">
                ...
                <div class="itinerary_right">
                  ...
                  <div>
                    ...
                    <span class="description">After breakfast leave early morning at 8 am, drive to Hall of Fame (Run by the Indian Army), then visit Spituk Monastery 11th Century monastery. Drive towards Pathar Sahib, Magnetic Hill and Indus Zanskar meeting point. Spend this day to explore the Leh City and Monasteries around Leh.</span>
              ...
              <li class="icon-box">
                ...
                <div class="itinerary_right">
                  ...
                  <div>
                    ...
                    <span class="description">After breakfast start drive to Leh, enroute visiting Thiksey Palace, Hemis Monastery and Rancho School.</span>
          ...
          <div class="margin-bottom-15px">
            ...
            <input type="checkbox" name=""> I Agree to the <a href="javascript:void(0);" data-toggle="modal" data-target="#terms">Terms and Conditions</a>
                       ...
                       <input type="hidden" id="landing" name="landing" value="Leh" />
                        ...
                        <input type="hidden" id="adgroup" name="adgroup" value="Leh-Lp1" />
