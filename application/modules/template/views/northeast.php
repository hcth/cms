            ...
            <div class="container">
                <div class="wrapper">
                    <div class="banner-content banner-box">
                        <h2>Discover the beauty of the Land of Seven Sisters in the North East</h2>
                        <ul>
                            <li><img src="<?php echo base_url() ?>packassets/images/flag.svg" alt="North east trip"><b>Destination:</b> North East </li>
                            <li><img src="<?php echo base_url() ?>packassets/images/star.svg" alt="Seven Sisters trip"><b>Trip category:</b> Adventure </li>
                            <li><img src="<?php echo base_url() ?>packassets/images/airpalne.svg" alt="vacation now at north east"><b>Best time to visit:</b> Nov - May
                            </li>
                            <li><img src="<?php echo base_url() ?>packassets/images/calender.svg" alt="week trip"><b>Stay days:</b> 7 Nights and 8 Days
                            </li>
                            <li><img src="<?php echo base_url() ?>packassets/images/tag.svg" alt="low budget trips"><b>Budget:</b> ₹21,599 Per Person onwards
                            </li>
                            <li><img src="<?php echo base_url() ?>packassets/images/waycheck.svg" alt="friends vacation">
                                <p><b>Suitable for:</b> Friends, Families, Solo Travellers, Honeymoon</p>
                            </li>
                        </ul>
                    </div>
                        ...
                        <form class="stay_middle fixed" id="packageform">
                            ...
                            <div class="bnr-input-cover">
                                <select class="form-control" name="package" id="package">
                                    ...
                                    <option>5N 6D North East</option>
                                    <option>6N 7D North East</option>
                                    <option>North East Customized</option>
                                </select>
                            </div>
                            <div class="wp-update">
                            ...
                            <div class="faq-accodian">
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr active">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 1</h2>
                                            <h4 class="">Guwahati Airport / Rly Station – Shillong</h4>
                                        </div>
                                    ...
                                    <p class="active" style="display: block;">
                                        ...
                                        On arrival at Guwahati Airport / Railway Station & transfer to Shillong (4,900 ft.), called 'Scotland of the East". Enroute visit Umiam Lake, a majestic placid lake with its surrounding sylvan hills. On arrival at Shillong, check in at your hotel. Overnight stay at Shillong.
                                    </p>
                                </div>
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 2</h2>
                                            <h4>Excursion to Cherrapunjee</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 2 Hours Sightseeing</span>

                                        After early breakfast, drive to Cherrapunjee (4,400 ft.), the wettest place in the world.
                                        You will see the beautiful waterfall known as Nohkalikai. You can also explore the caves known as Mawsmai. Evening return to Shillong, enroute visit Elephanta falls and Shillong peak for some breathtaking views. Overnight stay at Shillong.
                                    </p>
                                </div>
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 3</h2>
                                            <h4 class="">Excursion to Mawlynnong & Dawki</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 5 Hours</span>

                                        After an early breakfast drive to Mawlynnong – “Asia’s Cleanest Village''. Mawlynnong
                                        offers many interesting sights such as the living root bridge and another strange natural
                                        phenomenon of a boulder balancing on another small rock. Later proceed to Dawki, a small
                                        town near the India Bangladesh border. Enjoy the breathtaking view of the Umngot River. Evening drive back to Shillong. Stay overnight at your hotel in Shillong.
                                    </p>
                                </div>
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 4</h2>
                                            <h4 class="">Shillong Local Sightseeing</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 4 Hours</span>

                                        After breakfast we proceed to the local sightseeing area of Shillong.<br><br>
                                        ● Laitlum Canyons<br>
                                        ● Don Bosco Center for Indigenous Cultures<br>
                                        ● Ward's Lake<br>
                                        ● Cathedral Catholic Church<br>
                                        ● Lady Hydari Park<br>
                                        ● Golf Course<br><br>
                                ...
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 5</h2>
                                            <h4 class="">Shillong - Kaziranga National Park</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 7 Hours</span>

                                        After breakfast, transfer to Kaziranga National Park, the home of “One Horned Rhinoceros”. Check in at your hotel. Evening is free for leisure. Overnight stay at Kaziranga.
                                    </p>
                                </div>
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 6</h2>
                                            <h4 class="">Kaziranga National Park</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 4-5 Hours</span>

                                        Early morning explore any one zone of Kaziranga National Park on the back of Elephant. Apart from the Rhino, other species found are Hog Deer, Swamp Deer, Wild Buffalo, Elephants and if you are lucky then tiger also. It is also home to pelicans, storks and darters as there are a number of water bodies inside the Park. Return to the resort for breakfast. In the afternoon enjoy jeep safari through the National Park. Return to the hotel. Overnight stay at Kaziranga.
                                    </p>
                                </div>
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 7</h2>
                                            <h4 class="">Kaziranga National Park – Guwahati</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">
                                        ...
                                        After Breakfast drive to Guwahati. Check in at Hotel. Guwahati, ‘The light of the East’ is
                                        the commercial capital of North East lying adjacent to the shores of the turbulent Brahmaputra.
                                        Evening enjoy a River cruise over the river Brahmaputra (cruise charges additional).
                                ...
                                <div class="question-bx-cvr">
                                    <div class="wrapper net-cvr">
                                        <div class="question-bx-cvr-text">
                                            <h2>Day 8</h2>
                                            <h4 class="">Hotel – Guwahati Airport / Rly Station</h4>
                                        </div>
                                        <span><img src="<?php echo base_url() ?>packassets/images/arrow.png" alt=""></span>
                                    </div>
                                    <p class="active" style="display: none;">

                                        <span>Travel Time: 6 Hours</span>
                ...
                <div class="gallary-cvr">
                    <div class="wrapper">
                        <div class="inclusions">
                            ...
                            <h2>Inclusions</h2>
                            <ul>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Accommodation on Double sharing basis as per the mentioned hotel</li>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Provide meal as per the meal plan at Hotel</li>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">All transfers as per the itinerary by Private vehicle</li>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">All sightseeing as per the itinerary by Private vehicle</li>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">All parking and toll tax as the mentioned point in itinerary</li>
                                <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Meghalaya eInvite</li>
                            </ul>
                        </div>
                        <div class="exclusions">
                            <div class="exclusions-full">
                                ...
                                <h2>Exclusions</h2>
                                <ul>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">All Entry Fees
                                    </li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Meals other than those specified above</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Personal expenses like porter charges, tips, laundry, mineral water etc</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Monument entrances, camera charges, parking charges etc.</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Elephant and Jeep Safari Charges</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Any activity not mentioned in the inclusions</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Room heater or blower in room [If hotel provide on complimentary basis then it included]</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Travel Insurance</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">Additional cost due to flight cancellation/ roadblocks, Political unrest etc.</li>
                                    <li><img src="<?php echo base_url() ?>packassets/images/dot.png" alt="">GST as applicable</li>
                                </ul>
                ...
                <section class="img-gallery-magnific">
                    ...
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/shillong-trip.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/shillong-trip.jpg" alt="shillong trip" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                        <div class="magnific-img medium">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/cherrapunjee-trip.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/cherrapunjee-trip.jpg" alt="cherrapunjee trip" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="magnific-img-cvr imgbox-md">
                        <div class="magnific-img large">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/north-east-vacation.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/north-east-vacation.jpg" alt="north-east-vacation" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-last-part imgbox-md">
                        <div class="magnific-img small">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/north-trips.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/north-trips.jpg" alt="north trips" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/shillong-vacation.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/shillong-vacation.jpg" alt="shillong vacation" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/kaziranga-national-park.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/kaziranga-national-park.jpg" alt="kaziranga national park" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/sightseeing-in-north.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/sightseeing-in-north.jpg" alt="sightseeing in north" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/trips-in-north.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/trips-in-north.jpg" alt="trips in north" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/adventourist.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/adventourist.jpg" alt="adventourist trips" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
                    <div class="popup-slider-middle-part imgbox-md">
                        <div class="magnific-img medium ">
                            <a class="image-popup-vertical-fit" href="<?php echo base_url() ?>packassets/images/gallery/wonders-of-the-north.jpg" title="">
                                <img src="<?php echo base_url() ?>packassets/images/gallery/wonders-of-the-north.jpg" alt="wonders of the north" />
                                <i class="fa fa-search-plus" aria-hidden="true"></i>
                            </a>
                        </div>
                    </div>
