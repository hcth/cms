                ...
                <table  id="storiesTable" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach ($commentRec as $value) { 
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo base_url()?>stories/detail/<?php echo modules::run('stories/getStoriesUrl',$value->storyid); ?>" target="_blank"><?php echo $counter; ?></a>
                                </td>
                                <td>
