<style type="text/css">
.crm_card{border:1px solid #f2f3f8;text-align:center;border-radius:7px;-webkit-border-radius:7px;padding-top:10px;padding-bottom:10px;margin-bottom:15px}
.crm_card.active{border:1px solid #62a4e2}
.crm_card .crm_count{color:#62a4e2;font-size:1.5rem;font-weight:600;line-height:initial}
.crm_card .m-radio{margin-bottom:0;font-size:12px;width:100%;padding-left:10px;padding-right:10px}
.mt_25{margin-top:25px!important}
.crm_card .m-radio>span{margin-right:auto;margin-left:auto;right:0}
.lead_details_title{font-size:16px}
.received_leads{border-bottom:1px solid #f2f3f8;margin-top:1rem}
.bootstrap-timepicker-widget .th,.bootstrap-timepicker-widget td{border:none;font-size:14px}
@media (max-width: 768px) {
.center_below_768{text-align:center!important}
.mt_below_768{margin-top:20px!important}
#LeadsTable .row .col-md-4,#LeadsTable .row .col-md-2{margin-bottom:15px}
}        
</style>
                        ...
                        <div class="m-widget24 text-center">
                            <div class="m-widget24__item">
                                <h4 class="m-widget24__title m--icon-font-size-lg2">
                                    <a href="#newleadmodal" class="m--font-danger" data-toggle="modal">
                                        <i class="fa fa-plus-square-o m--icon-font-size-lg2"></i> 
                                        Add New Lead
                                    </a>
                                </h4>
                            </div>
                    ...
                    <div class="tab-pane active" id="LeadsTable" role="tabpanel">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 center_below_768">
                                <a href="#" id="getClientList"
                                    class="btn btn-info m-btn m-btn--custom m-btn--icon m-btn--pill">
                                    Apply
                                </a>
                                <a href="javascript:void(0)" id="resetFilter"
                            ...
                            <!-- <div class="col-md-6 text-right center_below_768 mt_below_768">
                                <div class="m-dropdown m-dropdown--inline m-dropdown--arrow"
                                    data-dropdown-toggle="click">
                                    <a href="#"
                                        class="m-dropdown__toggle btn btn-secondary m-btn m-btn--custom m-btn--icon m-btn--pill">
                                        <i class="la la-columns"></i> Columns
                                    </a>
                                                        ...
                                                        <li class="m-nav__item">
                                                            <div class="m-checkbox-list">
                                                                <label class="m-checkbox">
                                                                    <input type="checkbox" class="hide_lead">
                                                                    Hide a
                                                                    <span></span>
                                                                </label>
                                                            </div>
